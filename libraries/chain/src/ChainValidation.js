...
*/
function is_account_name(value, allow_too_short = false) {
...
function is_account_name_error(value, allow_too_short) {
...
function is_empty_user_input(value){
    if (is_empty(value)) { return true; }
    if ((value+"").trim() === "") { return true; }
    return false;
}

function required(value, field_name=""){
    if (is_empty(value)) {
...
function is_valid_symbol_error(value) {
...
module.exports = {
    ...
    is_empty: is_empty,
    is_account_name_error: is_account_name_error,
    is_cheap_name: is_cheap_name,
    is_empty_user_input: is_empty_user_input,
    required: required,
    is_valid_symbol_error: is_valid_symbol_error
};
