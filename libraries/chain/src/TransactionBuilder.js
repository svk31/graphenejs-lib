...
var { Signature, PublicKey, Aes, hash } = require("../../ecc");
...
var ChainConfig = require('./Config');
var helper = require('./TransactionHelper');

var ChainStore = require("./ChainStore");
    ...
    */
    ...
    set_required_fees(asset_id){
        ...
        if (asset_id !== "1.3.0") {
            ...
            promises.push(ChainStore.FetchChain("getAsset", asset_id));
        }
